...
Canonical Lane research workspace for a flagship problem in arithmetic geometry and Diophantine geometry:
proving sparsity of rational points on varieties of general type through an admissible rational-point closure architecture.

## Main Manuscript

- [paper/BOMBIERI_LANG_CONJECTURE_PREPRINT.md](paper/BOMBIERI_LANG_CONJECTURE_PREPRINT.md)
- [paper/CANONICAL_ROUTING_INDEX.md](paper/CANONICAL_ROUTING_INDEX.md)

## Structure

- `paper/`
  - `BOMBIERI_LANG_CONJECTURE_PREPRINT.md`
...
1. Theorem chain first: read `paper/BOMBIERI_LANG_CONJECTURE_PREPRINT.md`.
...
Current BL runner policy:

- `repro/run_repro.sh` extracts, promotes, runs `scripts/bl_closure_guard.py`, updates `repro/repro_manifest.json`, and enforces `fully_extracted` release-gate mode.
...
3. artifact key consumed by `scripts/bl_closure_guard.py`.
...
- Manuscript target: [paper/BOMBIERI_LANG_CONJECTURE_PREPRINT.md](paper/BOMBIERI_LANG_CONJECTURE_PREPRINT.md)
