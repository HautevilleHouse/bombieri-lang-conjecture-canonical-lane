...
- `kappa_rational` from `c_rational_raw * rational_density_raw - e_rational_raw`
- `sigma_sparsity` from `sparsity_floor_raw - truncation_loss_raw - restart_loss_raw`
- `kappa_compact` from `1.0 / (1.0 + delta_comp_sup_raw)`
- `rho_rigidity` from `rho_rigidity_raw`
- `lang_transfer` from `c_transfer_raw * transfer_gain_raw - e_transfer_raw`
