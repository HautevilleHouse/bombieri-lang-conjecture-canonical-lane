#!/usr/bin/env python3
"""Canonical-lane closure guard for the bombieri lang conjecture workspace."""
...
def compute_report(data: dict[str, Any], sigma_star: float | None, strict_coh_zero: bool) -> dict[str, Any]:
    ...
    native_names = ['BL_G1', 'BL_G2', 'BL_G3', 'BL_G4', 'BL_G5']
    gates = {name: ('PASS' if passed else 'FAIL') for name, passed in zip(native_names, gate_pass)}
    gates['BL_G6'] = 'PASS' if coh_pass else 'FAIL'
    gates['BL_GM'] = 'PASS' if gm_pass else 'FAIL'
    blockers = {}
